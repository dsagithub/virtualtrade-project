...
////////////////////////////////////-->
	<header class="main">
		<div class="container">
			<div class="row">
				<div class="span2">
					<a href="index.html"> <img src="img/logo-small.png" alt="logo"
				...
				<div class="span8">
					...
					<nav>
						<ul class="nav nav-pills flexnav" id="flexnav"
							...
							<li><a href="http://localhost:8080/virtualtrade-auth/users/users.html">Buscar Usuario</a></li>		
							<li><a
								href="http://localhost:8080/virtualtrade-auth/contact.html">Contactar</a>
							</li>
						</ul>
					</nav>
					<!-- END MAIN NAVIGATION -->
				...
				<div class="span2">
					...
					<ul class="login-register">
						<li><a class="popup-text"
							href="http://localhost:8080/virtualtrade-auth/login.html"
