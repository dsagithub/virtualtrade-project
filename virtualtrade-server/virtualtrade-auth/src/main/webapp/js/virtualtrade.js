...
$("#button_get_anuncios_descendente").click(function(e) {
        e.preventDefault();
        getAnuncios_Descendentes();
        console.log("pulso el boton")
});

$("#button_get_anuncios_ascendente").click(function(e) {
    e.preventDefault();
    getAnuncios_Ascendentes();
});
...
function getAnuncios_Descendentes() {
    console.log("atributo_descendente")
    var url = API_BASE_URL + "/anuncios/orderby?offset=0&length=9&precio=DESC";
...
function getAnuncios_Ascendentes() {
    console.log("atributo_descendente")
    var url = API_BASE_URL + "/anuncios/orderby?offset=0&length=9&precio=ASC";
...
function getanuncio_palabra() {
        var atributo_search = $("#atributo_search").val();
        console.log(atributo_search)
